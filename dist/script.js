const arabicTranslations = {
  ...
  'ACTIVE': 'نشط', 'ARABIC LEARNING PLATFORM': 'منصّة تعلّم عربية', 'EDUCATION · CYBERSECURITY': 'التعليم · الأمن السيبراني',
  ...
  'Built for real-world control.': 'مصمّم للتحكّم الواقعي.', 'Encrypted vault': 'خزنة مشفّرة', 'Credentials, cards, TOTP records, and file attachments are protected with a deliberate local security model.': 'تحمي بيانات الدخول والبطاقات وسجلات TOTP ومرفقات الملفات عبر نموذج أمان محلي مدروس.', 'Trusted devices exchange signed pairing cards, snapshots, and secure Capsules without cloning device identity.': 'تتبادل الأجهزة الموثوقة بطاقات اقتران موقّعة ولقطات وحاويات آمنة دون استنساخ هوية الجهاز.', 'Recovery first': 'الاسترداد أولاً', 'Encrypted backups validate before restoration, while expired licenses preserve read-only access for export and backup.': 'تتحقق النسخ الاحتياطية المشفّرة قبل الاستعادة، فيما تحافظ التراخيص المنتهية على وصول للقراءة فقط للتصدير والنسخ الاحتياطي.', 'Delivering a polished local-first vault with secure exchange, recovery, and a refined reduced-motion-aware interface.': 'تقديم خزنة محلية متقنة مع تبادل آمن واسترداد وواجهة تراعي تقليل الحركة.',
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const applyLanguage = (nextLanguage) => {
    ...
    if (isArabic) document.title = arabicTitles[filename] || document.title;
